const Anima = () => {
	...
	(function (u, r) {"function" === typeof define && define.amd ? define ([], r) : "object" === typeof module && module.exports ? module.exports = r () : u.anime = r ()}) (this, function () {
		...
		function Y (a) {
			var b = L (a);
			return b.map (function (a, d) {return { target: a, id: d, total: b.length }})
		}
		...
		function N (a, b, c) {
			...
			return b.length ? d.apply (Math, b.map (function (b) {return b[a]})) : c[a]
		}
		...
		function m (a) {
			...
			function h (a) {
				var h = f.duration,
					k = f.offset, m = f.delay, O = f.currentTime, p = f.reversed, q = c (a),
			...
			D, g = {
				...
				var b = "Quad Cubic Quart Quint Sine Expo Circ Back Elastic".split (" "), c = {
					...
					Out: [ [ .25, .46, .45, .94 ], [ .215, .61, .355, 1 ], [ .165, .84, .44, 1 ], [ .23, 1, .32, 1 ], [ .39, .575, .565, 1 ], [ .19, 1, .22, 1 ],
						[ .075, .82, .165, 1 ], [ .175, .885, .32, 1.275 ], function (b, c) {return 1 - a (1 - b, c)} ],
